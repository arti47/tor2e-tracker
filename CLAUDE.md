...
**Recommended order: 1 (deploy) → 2 (table test). 5 and 7 only if a real need emerges. Items 3, 4, 6 ✅ done 2026-07-02, item 8 ✅ done 2026-09-12.** The blocker on deploying — a Play tab that dead-ended — is fixed, so item 1 is now genuinely next.
