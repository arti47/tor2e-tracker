...
**Recommended order: 1 (deploy) → 2 (table test). 5 and 7 only if a real need emerges. Items 3, 4, 6 ✅ done 2026-07-02, items 8 and 9 ✅ done 2026-09-12 / 2026-09-13.** Both playtest backlogs are closed, so the deploy is unblocked — but **play it again before shipping** (GOTCHA 16): this batch touched the session loop, the lifecycle and the oracle surfaces, which is exactly what the playtester is for. A third run is the gate on item 1, not a nice-to-have.
