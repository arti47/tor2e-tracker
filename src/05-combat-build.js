...
const REFERENCE = {
  ...
  solo: [
    ...
    ['Starting a campaign', 'You need one thing a character sheet cannot give you: a <strong>reason to leave home</strong>. A patron\'s errand, a rumour, a debt, a threat to somewhere you love. Write one sentence, open a scene, and say what your hero does first. Everything else follows from that.'],
    ['Sustaining a campaign', 'Play in <strong>sessions</strong>. Start each by re-reading your last scene; end each by awarding experience and noting where you stopped. Between stretches of adventuring, take a <strong>Fellowship Phase</strong> — that is where Hope returns and points are spent. Adventure → Fellowship Phase → adventure is the rhythm of a campaign.'],
    ['Ending a campaign', 'Stories end better than they fade. A hero can <strong>retire</strong> to the haven they fought for, <strong>fall</strong> and leave the Chronicle as their memorial, <strong>pass on</strong> (sailing West, or going under the Mountain), or simply <strong>stop</strong> when the tale you wanted is told. Rising Scars, high Valour or Wisdom, and several completed Fellowship Phases are all signs the moment has come.'],
