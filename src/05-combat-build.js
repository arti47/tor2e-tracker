...
const REFERENCE = {
  ...
  terms: [
    ...
    ['Eye of Mordor', 'The solo game\'s dread clock. <strong>Eye Awareness</strong> climbs as you use magic, gather Shadow and roll badly; when it reaches the region\'s <strong>Hunt threshold</strong>, the Enemy notices you and a Revelation Episode strikes, then it resets.'],
    ...
    ['Scene', 'One chunk of story — a conversation, a search, a fight. Open a scene, write what happens, then start the next. Scenes are how a solo journal is organised.'],
