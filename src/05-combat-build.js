...
const REFERENCE = {
  ...
  terms: [
    ...
    ['Combat Action Deck', 'A Loremaster prompt: draw a card to decide what an adversary does this round instead of choosing. Keeps foes from all behaving the same way.'],
