...
const REFERENCE = {
  ...
  terms: [
    ...
    ['Heroic Culture', 'The people your hero comes from. It is the single biggest creation choice: it sets your starting attribute options, skills, combat proficiencies, a <strong>Cultural Blessing</strong>, and which Distinctive Features and Virtues you may take.'],
    ['Calling', 'Why your hero adventures — Captain, Champion, Messenger, Scholar, Treasure Hunter, Warden. It grants favoured skills and a Distinctive Feature, and it fixes your <strong>Shadow Path</strong>: the particular way your hero breaks if the Shadow takes them.'],
    ['Distinctive Feature', 'A short phrase describing your hero’s nature (Bold, Fair-spoken, Wary…). Invoke one to become <strong>Inspired</strong> when it plausibly applies — that is its mechanical use.'],
    ['Previous Experience', 'A one-off budget spent during character creation to raise starting skills and combat proficiencies above your culture’s baseline. It uses cheaper creation-time costs than in-play XP, and it is spent once — after that you advance with Skill and Adventure Points.'],
    ['Skill Points / Adventure Points', 'The two XP currencies. <strong>Skill Points</strong> raise the 18 skills; <strong>Adventure Points</strong> raise combat proficiencies, Valour and Wisdom. You earn both at the end of a session and normally spend them in the Fellowship Phase.'],
    ['Marching Test', 'The roll that moves a journey along: the Guide rolls <strong>TRAVEL</strong>, and how well they do decides how many hexes you cover and how much time and Fatigue it costs. In solo play your lone hero is always the Guide.'],
    ['Journey Event', 'What the road throws at you between marches — from a Joyful Sight to a Terrible Misfortune. The Feat die picks the event, modified by the region you are crossing; the targeted role rolls a skill to handle it.'],
    ['Blessing (magical item)', 'A skill named on a Marvellous or Wondrous item. Whenever you roll that skill the item grants <strong>+2d</strong> automatically, and a Magical Success becomes available on that roll.'],
    ['Scene', 'The unit your solo story is written in: a place, a moment, and something you want. Open one, play it out — writing prose and rolling as needed — then close it and open the next. Your rolls and oracle answers file themselves into the open scene.'],
    ...
    ['Hate', 'An adversary’s version of Hope — the pool spent to make a foe hit harder or resist longer. In a group the Loremaster spends it; playing solo, you do, on the monsters’ behalf. Ordinary people have <em>Resolve</em> instead.'],
    ['Stance', 'How you are fighting this round: <strong>Forward</strong> (aggressive — easier for foes to hit you), <strong>Open</strong> (balanced), <strong>Defensive</strong> (cautious), <strong>Rearward</strong> (ranged only), and <strong>Skirmish</strong> in Strider Mode. Each unlocks its own Combat Task and changes your dice.'],
    ['Engaged Foes', 'How many adversaries are in your face right now. It matters mainly in Defensive stance, where your own attacks lose 1 die per engaged foe. The Encounter tracker keeps this in step automatically.'],
    ['Foe Parry', 'The defence score of whatever you are attacking — it is added to your Target Number, so a well-armoured foe is harder to hit. The Encounter tracker fills this in per foe.'],
    ['Parry Total', 'Your own defence number, Parry plus any shield. An adversary must beat this to hit you.'],
    ['Opening Volley', 'The exchange of arrows before the lines meet. If you are aware of it and braced, your shield counts <strong>double</strong> against that ranged attack.'],
    ['Encounter', 'The fight tracker: add adversaries, attack them, let them attack back, and step the round counter. It applies damage, wounds and Protection rolls for you.'],
    ['NPC Ledger', 'A place to keep the people your heroes meet — name, role, what stands out about them — so a returning face stays consistent between sessions. Device-wide, not tied to one hero.'],
    ['Combat Action Deck', 'A prompt for whoever is running the foes — the Loremaster in a group, you in solo play. Draw a card to decide what an adversary does this round instead of choosing, so enemies don\'t all behave the same way.'],
    ['Group Shadow Test', 'One Shadow test rolled for every hero at once — Dread, Greed or Sorcery. Each hero uses their own Weary and Despair state; failures show a button to hand out the Shadow.'],
    ['Skill', 'What your hero is good at, rated 0–6 in ◆ pips. A ★ marks a <strong>Favoured</strong> skill. You raise skills with Skill Points during a Fellowship Phase, not in the middle of an adventure.'],
    ['Combat Proficiency', 'How well you fight with a class of weapon — Axes, Bows, Spears, Swords. The rating is how many Success dice you roll to attack, and it also sets how many weapons of that type you may carry. <strong>Brawling</strong> is derived: your best proficiency minus 1.'],
    ['Hexes', 'Journeys are measured in map hexes. <strong>Total Hexes</strong> is the distance; <strong>Hard Terrain</strong> is how many of those are rough going, which costs extra days.'],
    ['Journey Role', 'On a journey each hero takes a job — Guide, Hunter, Look-out, Scout. Playing solo you cover all of them, so the app rolls whichever the event calls for.'],
    ['Roleplay bonus', 'A bonus the Loremaster may grant for a good argument or a well-played moment: +1d for relevant, +2d for brilliant. Playing solo, award it honestly or leave it at none.'],
    ['Tale of Years', 'The campaign calendar, in Shire Reckoning. It stamps each scene with a date and mostly advances itself — a Prolonged Rest adds a day, arriving somewhere adds the travel days, Yule turns the year.'],
    ['Reward', 'A permanent upgrade to a piece of war gear, earned at a new <strong>Valour</strong> rank — a keener blade, tougher armour. Applied to a specific item, and the app adjusts that item\'s numbers for you.'],
    ['Virtue', 'A permanent upgrade to your <em>hero</em> rather than their gear, earned at a new <strong>Wisdom</strong> rank — more Hope, a better Parry, a new trick. Some are open to anyone; others belong to your culture.'],
    ['Success die', 'The six-sided dice you roll alongside the Feat die. How many you roll is the rating of whatever you are using — a Skill, a Combat Proficiency, Valour or Wisdom. A <strong>6</strong> on one is a ✦ success icon.'],
    ['Piercing Blow', 'A hit that finds a gap in the armour. It happens on a Feat die of 10 or the Gandalf rune (9+ with a Keen weapon), and forces the victim to make a <strong>Protection</strong> roll or take a Wound.'],
    ['Resolve', 'The courage of a thinking enemy — a person\'s equivalent of <strong>Hate</strong>, which monsters have instead. Same job: the pool that keeps them fighting.'],
    ['Combat Task', 'Instead of attacking, you can spend your turn helping — intimidating a foe, rallying allies, shielding a companion, lining up a shot. Which one is available depends on your <strong>Stance</strong>.'],
    ['Eye Awareness', 'The number the <strong>Eye of Mordor</strong> tracks. It rises when you draw attention — magic, Shadow, a bad roll — and when it reaches the region\'s Hunt threshold, something finds you.'],
    ['Revelation Episode', 'What happens when Eye Awareness reaches the Hunt threshold: the Enemy acts against you, rolled from a table. Afterwards the Eye resets and starts climbing again.'],
  ...
  solo: [
    ...
    ['Telling Table', 'For <strong>closed</strong> questions about the world — a place, a person, a creature, an event. Phrase it so <strong>“yes” is what your hero would want</strong>, then pick how likely that feels and roll; you get YES or NO, sometimes with a twist. Only ask when you genuinely don’t know, or when both answers would be interesting — if the story already makes it obvious, just say it. Open-ended questions go to the <strong>Lore Table</strong> instead.'],
    ['Lore Table', 'For the <strong>open-ended</strong> questions the Telling Table cannot take — what happens next, who this is, what is going on. Roll <strong>one</strong> column for a single word, or two or three to build a phrase. Read it literally or as an abstraction, whichever fits your situation; deciding how the riddle applies is the point. If a result doesn\'t fit, <strong>roll again or check the adjacent rows</strong> — you are never stuck with an unusable answer.'],
    ...
    ['Mission (Moria)', 'Each Moria expedition starts with a <strong>mission</strong> from Balin. You set its objective, then pick the Band’s <em>composition</em> — Size, War Gear, Specialisation. Composition is the trade-off at the heart of the campaign: a bigger, better-armed band is stronger but louder, so it raises your Eye Awareness and lowers the Hunt Threshold.'],
    ['Hunt Threshold', 'The Eye Awareness score at which the Enemy finds you. Region sets the base (Border 18 · Wild 16 · Dark Land 14 — Moria is a Dark Land), then mission choices and recent history shift it. Reach it and a Revelation Episode fires.'],
    ['Damage Threat', 'How dangerous the current situation is to your Band. It is added to the Readiness TN on an Endurance Test — the higher the threat, the harder the Band holds together.'],
    ['Endurance Test (Band)', 'Rolled when the Band takes punishment. Roll <strong>Rally</strong> against the Readiness TN + Damage Threat. On a failure one ally on the mission takes an injury (or an existing one worsens).'],
    ['Fatigue Test (Band)', 'Rolled when the Band is worn down. Roll <strong>Rally</strong> against the Readiness TN + accumulated Fatigue points, with dice added or removed by <strong>Burden</strong>. Failure fatigues an ally.'],
    ['Ally Gift / Quirk', 'Every ally is generated with one <strong>Gift</strong> (a mechanical boon you can invoke for +1d on a Band roll) and one <strong>Quirk</strong> (flavour — a personality hook to roleplay). A Gift is <em>wasted</em> if the roll it was spent on comes up with an Eye.'],
    ['Kingly Gift', 'A famous item handed to a <strong>Hardened</strong> ally in the Fellowship Phase. It grants that ally a second Gift and lets them ward off one Eye result by re-rolling it.'],
    ['Desperate Stand', 'A last resort after a failed roll: an ally throws themselves into the breach. Re-roll Favoured and Inspired; if an Eye comes up the ally survives, otherwise they are lost and you gain Shadow.'],
    ['Hero or Band?', 'A solo tie-breaker for “who does this hit?”. Roll one Success die — odd means the Band suffers it, even means your own hero does. Use it whenever the fiction doesn’t make the target obvious.'],
    ['Shared Calling', 'The Moria equivalent of a Calling, describing the Band’s role rather than one hero’s (Reclaimers, Pathfinders, Standard-Bearers, Guardians, Vanguards). It sets your <strong>Disposition Focus</strong> and your favoured skills.'],
    ['War Party (Battle)', 'The enemy force in a Moria <strong>Battle</strong>. Roll or set its <em>Scale</em>, which gives you its two key numbers: <strong>Might</strong> (added to your TN — how hard it is to fight) and <strong>Resistance</strong> (how much punishment it absorbs before it breaks).'],
    ['Might (foe)', 'The enemy’s raw power in a Battle. It is added to your Readiness TN on every Clash roll, so a mightier foe makes each exchange harder.'],
    ['Foe Resistance', 'The Battle’s health bar. Every success you spend on attacking reduces it; drive it to <strong>0</strong> and you win the battle.'],
    ['Archfoe', 'A named enemy leader in the Battle (Lesser or Greater). They worsen your rolls until you spend successes to <em>Harry</em> them. Fighting one personally is a Duel — resolve that on the Combat and Dice tabs.'],
    ['Leader Focus', 'Step 1 of a Clash: how your hero leads this exchange — <em>Command, Inspire, Fight,</em> or <em>Duel</em>. It changes which dice you get and what your successes can buy.'],
    ['Band Stance', 'Step 2 of a Clash: how the Band commits — <em>Aggressive, Balanced, Guarded,</em> or <em>Fleeing</em>. Like a hero’s combat stance, it trades risk against effect.'],
    ['Advantage / Complication', 'Battlefield state you accumulate. An <strong>Advantage</strong> adds dice to later Clashes; a <strong>Complication</strong> subtracts them. Successes can buy an Advantage or clear a Complication instead of damaging the foe — and a failed Clash loses every Advantage you held.'],
    ['Battlefield Aspect', 'A rolled feature of the ground you are fighting over (a bridge, a hall, darkness). It colours the battle and suggests what Advantages are worth pursuing.'],
    ['Moria Fellowship Phase', 'Moria’s downtime has three lengths instead of the usual Yule cycle: <strong>Hurried</strong> (hours — minimal recovery), <strong>Brief</strong> (days — 1 undertaking), <strong>Extended</strong> (weeks — 2 undertakings, best recovery). Longer rests recover more but cost time, which the Eye notices.'],
    ['Your saga', 'The whole arc of one hero\'s story, as opposed to a single roll or scene. It has three parts the app now walks you through: a <strong>beginning</strong> (a reason to leave home), a <strong>middle</strong> (sessions, with Fellowship Phases between adventures), and an <strong>ending</strong> you choose rather than drift into.'],
    ['Starting a campaign', 'Make one hero, then give them a reason to go. The book puts it as a story "focused on missions assigned by a <strong>Patron</strong>, or on personal goals or problems which compel your character to abandon the comfort of home and hearth". Introducing a Patron is the recommended way to kick off a new character — their quest tables supply both your first adventure and the next goal after it.'],
    ['Sustaining a campaign', 'An <strong>Adventuring Phase</strong> runs about <strong>two or three sessions</strong>, then a <strong>Fellowship Phase</strong> — a week to a whole season of rest, where Hope returns and experience is spent. Roughly every third Fellowship Phase is <strong>Yule</strong>, which ends the year. Playing solo, award experience by <strong>Milestone</strong> rather than per session: solo sessions run from minutes to hours, so session rewards stop matching what your hero actually did.'],
    ['Ending a campaign', 'The rules define three endings: your hero <strong>dies</strong> fighting the Enemy; they <strong>succumb to the Shadow</strong> — a hero ending an Adventuring Phase with Shadow equal to their maximum Hope leaves the Company and is retired; or they <strong>retire willingly</strong>, going home in peace, ideally before sorrow and regret nest too deeply. A Moria campaign has its own finish line: build a Band of <strong>twelve Hardened Allies</strong> and make one final great mission into the depths.'],
    ['The adventure loop', 'One adventure runs: <strong>1</strong> at a Safe Haven you learn why you must leave → <strong>2</strong> a <strong>Journey</strong> to get there → <strong>3</strong> the place itself, where the adventure happens (skill rolls, and a <strong>Council</strong> if the stakes are social) → <strong>4</strong> the Journey home → <strong>5</strong> a <strong>Fellowship Phase</strong> after two or three sessions of that. <strong>Combat is not a step</strong> — a fight can interrupt any of them; run it on the Combat tab and return to where you were.'],
    ['Play mode', 'The <strong>▶ Play</strong> tab runs the session for you. It says what is happening, offers a few things you could do, rolls whatever needs rolling when you pick one, tells you how it went, and writes it into your Chronicle. You can play a whole session without opening any other tab.'],
